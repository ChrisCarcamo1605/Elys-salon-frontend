// Analytics dashboard for admin. Uses Recharts (loaded via UMD).
function Analytics({ user, data, onLock, onBack }) {
  const R = window.Recharts;
  if (!R) return <div className="screen"><TopBar user={user} title="Analíticas" onLock={onLock} onBack={onBack} onLogout={onLock}/><div style={{padding:32}}>Cargando gráficos…</div></div>;
  ...
  const last7 = data.salesByDay.slice(-7);
  const last30 = data.salesByDay;
        ...
        <div className="ana-grid">
          ...
          <div className="card">
            ...
            <div style={{ height: 260 }}>
              <ResponsiveContainer>
                <BarChart data={data.topEmployees} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                  <CartesianGrid stroke="var(--border)" strokeDasharray="3 3" vertical={false}/>
          ...
          <div className="card">
            ...
            <div style={{ height: 240 }}>
              <ResponsiveContainer>
                <AreaChart data={data.hourlyTraffic} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                  <defs>
